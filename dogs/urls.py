...
from dogs.views import index, BreedListView, DogBreedsListView, DogsListView, DogCreateView, DogDetailView, DogUpdateView, DogDeleteView, dog_toggle_activity, DogsDeactivatedListView, DogSearchListView
